        ...
        <div class="requests-list">
            ...
            <?php else: ?>
                ...
                <div class="request-card">
                    <p style="color: black;"><strong>Услуга:</strong> <?= htmlspecialchars($request['service']) ?></p>
                    <p style="color: black;"><strong>Адрес:</strong> <?= htmlspecialchars($request['address']) ?></p>
                    <p style="color: black;"><strong>Дата:</strong> <?= $request['date'] ?> <?= $request['time'] ?></p>
                    <p style="color: black;"><strong>Статус:</strong> 
